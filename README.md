...
- [A helper for CircuitPython development with Atom] - A [helper is available](https://github.com/s-light/CircuitPython_Atom_helper) for the [Atom editor](https://atom.io/).
